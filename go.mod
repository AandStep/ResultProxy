...
require (
	...
	github.com/patrickmn/go-cache/v2 v2.0.0-00010101000000-000000000000 // indirect
...
replace github.com/sagernet/sing-box v1.13.11 => github.com/shtorm-7/sing-box-extended v1.13.11-extended-2.0.2
